...
- **仪表盘卡片筛选跳转设计（2026-07-06，待实现）**：
- 已形成设计方案：`仪表盘 -> 开站交付概况` 9 个卡片后续应统一跳转到站点列表，并通过 `site_progress_filter` 按同一仪表盘口径筛出对应站点。设计文档见 [仪表盘开站交付卡片筛选跳转设计](docs/superpowers/specs/2026-07-06-dashboard-site-card-filter-design.md)。
- **后端脚本清理（2026-03-26）**：
