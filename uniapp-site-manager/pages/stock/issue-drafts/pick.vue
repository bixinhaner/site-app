...
<script setup>
	...
	const localizeBackendErrorMessage = (message) => {
	...
	const extractErrorMessage = (data, fallback = '') => {
		...
		if (typeof detail === 'string') return localizeBackendErrorMessage(detail)
		if (detail?.message) return localizeBackendErrorMessage(detail.message)
