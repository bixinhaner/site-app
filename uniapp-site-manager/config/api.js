...
export const API_ENDPOINTS = {
  ...
  STOCK: {
    ...
    MY_RETURN_BATCHES: '/api/stock/my-return-batches',
    RETURN_WORKBENCH_BATCHES: '/api/stock/returns/workbench-batches',
    RETURN_DETAIL: (id) => `/api/stock/returns/${id}`,
    RETURN_RECEIVE: (id) => `/api/stock/returns/${id}/receive`,
    RETURN_REJECT: (id) => `/api/stock/returns/${id}/reject`,
    RETURN_VALIDATE_SN: '/api/stock/returns/validate-sn',
    RETURN_ACTUAL_CANDIDATES: '/api/stock/returns/actual-candidates',
