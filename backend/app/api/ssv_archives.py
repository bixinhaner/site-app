...
async def export_archive_zip(
    ...
    human_base = f"SSV档案_{site_code or ''}_{site_name or ''}_v{ver}_{ts}".strip('_')
...
async def export_archive_pdf(
    ...
    def draw_page_frame(canvas, doc_):
        ...
        canvas.drawString(2*cm, A4[1]-0.85*cm, "SSV档案报告 SSV Archive")
        # footer
    ...
    story = []
    # 封面标题
    story.append(Paragraph("SSV档案报告", styles["TitleCN"]))
