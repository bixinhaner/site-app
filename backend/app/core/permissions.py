...
BUILTIN_PERMISSION_DEFINITIONS = [
    ...
    {"code": "workorder:execute:web", "name": "Web工单执行", "module": "workorder"},
    ...
    {"code": "inventory:warehouse:all", "name": "全仓库存范围", "module": "inventory"},
...
# 内置角色默认边界在多个版本中有过调整。这里保留“已知旧模板”快照，
# 启动同步时仅当数据库中的系统角色权限集合与这些旧模板完全一致时，
# 才自动修正为当前模板，避免覆盖人工定制过的系统角色。
LEGACY_BUILTIN_ROLE_PERMISSION_VARIANTS: Dict[str, List[List[str]]] = {
    "inspector": [[
        "dashboard:view:read",
        "auth:web-login",
        "auth:app-login",
