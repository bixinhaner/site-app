...
BUILTIN_PERMISSION_DEFINITIONS = [
    ...
    {"code": "system:workorder-execution-settings:read", "name": "Web工单执行配置查看", "module": "system"},
    {"code": "system:workorder-execution-settings:write", "name": "Web工单执行配置管理", "module": "system"},
